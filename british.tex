...
\begin{outerlist}
\item[] \textbf{IT manager} \hfill \textbf{February 2011 - Present}
    \begin{innerlist}
...
\begin{outerlist}
\item[] \textbf{Web developer} \hfill \textbf{July 2012 - Present}
    \begin{innerlist}
...
J2EE, JEE)
\item Apprentice: C, C$+$$+$, C\#, Express-MP, Matlab, VHDL, Hadoop, Python (UNIX shell scripting).
