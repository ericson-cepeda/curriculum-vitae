...
\font\headers="Helvetica Neue LT Std:letterspace=5" at 20pt
\font\SectionHeaders="Helvetica:letterspace=5" at 14pt
...
\font\Text="Adobe Caslon Pro:color=2b2b2b" at 10pt 
\font\TextAlt="Calluna:color=CC3300" at 11pt
\font\TextSC="Calluna:+smcp, color=2b2b2b" at 11pt 
\font\slash="Calluna:+zero, color=2b2b2b" at 20pt
\font\slashAlt="Calluna:+zero, color=CC3300" at 15pt
...
\newcommand{% 
	\thumbnail}[2]{
		\raggedright{\href{#1}
			{\trick \raisebox{-1pt}{.}
				%\fbox{
			\includegraphics[keepaspectratio=true,width=100pt]{#2}}
			\raisebox{100pt}{.}}}
			%}
%Social ICONS 
\newcommand{\icons}[2]{
