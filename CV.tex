...
\font\TextAlt="Calibri:color=CC3300" at 10.8pt
...
\font\slashGray="Bebas Neue:+zero, color=2D2D2D, letterspace=4" at 34.5pt
...
\newfontfamily\FA[Color=namebox]{FontAwesome Regular}
...
\renewcommand{\section}[2]%
        {\pagebreak[2]\vspace{1.3\baselineskip}%
         ...
         \hspace{0in}%
         \marginpar{ 
         \vspace{-8pt}\raggedright\setstretch{1.45}\TextSC#1}\Text#2}
